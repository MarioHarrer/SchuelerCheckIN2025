...
{
    /// <inheritdoc />
    public partial class Schueler : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "Schuelerdatenset",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    email = table.Column<string>(type: "nvarchar(256)", nullable: false),
                    schluessel = table.Column<string>(type: "nvarchar(256)", nullable: false),
                    klasse = table.Column<string>(type: "nvarchar(256)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schuelerdatenset", x => x.Id);
                });
